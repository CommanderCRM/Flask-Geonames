...
def get_cities_by_name():
  ...
  if not city1 or not city2:
    return "Не указаны имена городов. Пример: добавить ?city1=Томск&city2=Северск к URL", 400
  ...
  return jsonify({"cities": [city_info1, city_info2], "northernmost_city": northernmost_city, "same_timezones": timezone_comparison, "time difference (h)": time_difference})
